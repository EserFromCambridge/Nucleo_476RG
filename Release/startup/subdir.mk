...
startup/%.o: ../startup/%.S
	...
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -Wall -Wextra  -g -x assembler-with-cpp -DSTM32L476xx -I"/Users/eser/eclipse-workspace/test1/Drivers/CMSIS/Device/ST/STM32L4xx/Include" -I"/Users/eser/eclipse-workspace/test1/Drivers/CMSIS/Include" -I"/Users/eser/eclipse-workspace/test1/Drivers/STM32L4xx_HAL_Driver/Inc" -I"/Users/eser/eclipse-workspace/test1/Inc" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
